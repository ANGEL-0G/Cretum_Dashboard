...
const COMPANIES = [
  ...
  { name: 'RapidSOS', q: '"RapidSOS"' },
  { name: 'BlueVoyant', q: '"BlueVoyant"' },
  { name: 'Jobandtalent', q: '"Jobandtalent" OR "Job and Talent"' },
  { name: 'Platform Science', q: '"Platform Science"' },
  { name: 'Wefox', q: 'wefox insurtech' },
  { name: 'HawkEye 360', q: '"HawkEye 360"' },
  { name: 'Trusted Health', q: '"Trusted Health" nursing' },
  { name: 'Forto', q: 'Forto logistics freight' },
  { name: 'Quantstamp', q: 'Quantstamp' },
  { name: 'Transfix', q: 'Transfix freight' },
  { name: 'Loft', q: '"Loft" Brazil real estate' },
  { name: 'Turo', q: 'Turo car sharing' },
  { name: 'IonQ', q: 'IonQ' },
  { name: 'Kodiak Robotics', q: '"Kodiak Robotics" OR "Kodiak AI"' },
  { name: 'Decart', q: '"Decart" AI' },
  { name: 'CHAOS Industries', q: '"CHAOS Industries"' },
  { name: 'Second Front', q: '"Second Front Systems"' },
  { name: 'Epirus', q: '"Epirus" defense' },
  { name: 'Radiant', q: '"Radiant" nuclear microreactor' },
  { name: 'Mythic', q: '"Mythic" AI chip' },
  { name: 'Cohesity', q: 'Cohesity' },
  { name: 'Saronic', q: 'Saronic Technologies' },
];
